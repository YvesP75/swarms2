...
BLUES_PER_CIRCLE = [4, 3, 3, 2, 6, 6]
BLUE_CIRCLES_RHO = [800, 1400, 1800, 2200, 2500, 3000]
...
RED_SQUADS = [3, 3, 3, 3, 4, 2]
RED_SQUADS_RHO = [1600, 1900, 2300, 2500, 2900, 5000]
RED_SQUADS_THETA = np.pi * np.array([0, 1/4, 1/4, -1/4, -1, 1/3])
RED_SQUADS_ZED = [300, 250, 100, 250, 200, 100]

RED_RHO_NOISE = [50, 40, 50, 200, 250, 300]
RED_THETA_NOISE = np.pi * np.array([1/10, 1/2, 1/4, 1/5, 1/10, 1/12])
RED_ZED_NOISE = [20, 50, 10, 10, 50, 60]

RED_SPEED_INIT = 0.0  # in ratio to max_speed

RED_COLOR = [150, 0, 0, 80]
...
DRONE_MODELS = {
    'alpha': {
          ...
          'Cz': 0.6,  # vertical air resistance
          'mass': 50,  # kg
          ...
          'Fxy_ratio': 0.4,  # Force xy relative to weight
    },
     'beta': {
